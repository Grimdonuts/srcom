...
public class MainActivity extends AppCompatActivity {
  ...
  //TODO: handle API elements that were unknown at the time. Occasional crashes when they do appear.. possible custom categories appearing in JSON returned from speedrun.com?
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    ...
    url =
      "https://www.speedrun.com/api/v1/runs?status=verified&orderby=submitted&direction=desc&max=10&embed=players,category,game";
    categoryName.clear();
    imageURL.clear();
    gameName.clear();
  ...
  private class GetRecent extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPreExecute() {
      ...
      pDialog.setMessage(
        "Please wait...Retrieving latest runs from speedrun.com.\n Tap outside this window dismiss this."
      );
