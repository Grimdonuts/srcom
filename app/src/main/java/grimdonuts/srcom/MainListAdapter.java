...
public class MainListAdapter extends ArrayAdapter<String> {
    ...
    public MainListAdapter(Activity context, ArrayList<String> itemname, ArrayList<String> images, ArrayList<String> categoryName, ArrayList<String> playerLeadTime) {
